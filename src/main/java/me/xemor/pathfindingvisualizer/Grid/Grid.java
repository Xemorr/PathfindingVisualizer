...
public class Grid {
    ...
    /**
     * Iterates over every tile in the grid and if it is a route tile, it is set to empty.
     */
    ...
    /**
     * Iterates over every tile in the grid and if it is a checked tile, it is returned to its original state.
     */
    ...
    public void setTile(Node node, Tile type) {
        grid[node.getX()][node.getY()] = type;
    }
